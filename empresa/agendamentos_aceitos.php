      ...
      <div class="row mt">
        <div class="col-lg-12">
          <div class="content-panel">
              <h4><i class="fa fa-angle-right fa-d"></i> Aceitos</h4>
                <?php                            
                ...
                <?php
                    for($i=0;$i<$num;$i++)
                    {
                      ...
                      echo '<tr class="warning">
                              ...
                              <td data-title="Cancelar"><form method="POST" action="tratar_agendamento.php"><input type="hidden" id="id" name="id" value=' . $agendamento[$i]->id . '><center><button type="submit" id="cancelar" name="cancelar" class="btn btn-danger"><i class="fa fa-times"></i></button></center></form></td>
                            </tr>';
                    }
                  ?>
                      </tbody>
