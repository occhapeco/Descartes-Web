 <header class="header black-bg">
            ...
            <div class="nav notify-row" id="top_menu">
                <a href="cadastro_pontos.php" style="font-size:17px; color:#797979; margin-left:100px; text-decoration:underline;">Adicionar Ponto</a>
                <a  href="mapa_pontos.php" style="font-size:17px; color:#797979; margin-left:50px; text-decoration:underline;">Meus Pontos</a>
                <a href="mapa_coletas.php" style="font-size:17px; color:#797979; margin-left:50px; text-decoration:underline;">Minhas Coletas</a>
                <a href="agendamentos.php" style="font-size:17px; color:#797979; margin-left:50px; text-decoration:underline;">Agendamentos</a>
