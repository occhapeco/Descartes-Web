    ...
    <script>
      function initAutocomplete() {
        ...
        var contentString = '<div id="content">'+
          ...
          '<p class="col-sm-6"> OEIOEIOEIOEOEIOEIEOIEOEI </p><p><a href="index.php"><button class="btn btn-primary">SUCESSO!</button></a></p>'+
          '</div>'+
          '</div>';
        ...
        var features = [
          {
            position: new google.maps.LatLng(-23.555859, -46.608207),
            type: 'mark1',
            info: contentString,
            draggable:false
          },
          {
            position: new google.maps.LatLng(-23.558479, -46.687006),
            type: 'mark1',
            info: contentString1,
            draggable:false
          }
