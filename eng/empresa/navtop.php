...
<header class="mobile">
  <div class="row">
    <div class="col full">
      <div style="margin-left:30px;"><a href="index.php" class="logo" style="color:white;"><img src="images/logo2.png" height="43px" width="130px" style="margin-top:-9px"></a></div>
		  ...
		  <li style="margin-left:150px;margin-right:20px;">
			...
			<li id="header_inbox_bar" class="dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-right" id="notification_bar">
					...
					<li style="width: 100%;">
						<a class="logout" href="../index/base/inicio/index.php" style="color: darkgray;">Logout</a>
					</li>
				</ul>
			</li>
