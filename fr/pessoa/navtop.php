...
<header class="mobile">
  <div class="row">
    <div class="col full">
      <div><a href="index.php" class="logo" style="color:white;"><img src="images/logo2.png" height="50px" width="130px" style="margin-top:-6px" class="img-responsive"></a></div>
        ...
        <ul id="nav" class="nav" >
			...
			<li id="header_inbox_bar" class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" id="notification_bar">
                    ...
                    <li style="width: 100%;"><center><a href="../../pt/empresa/"><img src="img/bndbr.png" width="20px;"></a></center></li>
                </ul>
            </li>
